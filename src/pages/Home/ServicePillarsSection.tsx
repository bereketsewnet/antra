...
const cards = [
  {
    ...
    body: 'We work with executive teams through the full arc — from leadership assessment and organisational design to strategy alignment and hands-on implementation. Most engagements run past the design phase, because that is where transformation work usually breaks down.',
  ...
  },
  {
    ...
    body: 'Our trading division sources electric vehicles, construction machinery, sanitary products, and medical equipment through our Djibouti Freezone operations. Direct manufacturer relationships, trade finance options, and after-sales support included.',
