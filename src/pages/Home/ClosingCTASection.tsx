  ...
  return (
    <section ref={ref} className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          Whether you're facing complex organizational, people, or leadership
          challenges that impact performance, growth, and sustainability, or you
          need a trusted partner for strategic sourcing and trade solutions,
          we're here to help.
        </motion.p>
